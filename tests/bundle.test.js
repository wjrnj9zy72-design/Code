...
test('the app never reaches for a browser modal', async () => {
  ...
  const sources = ['app.js', 'view-polls.js', 'view-lists.js', 'view-spends.js', 'view-ideas.js', 'swipe.js', 'view-games.js', 'view-groups.js', 'games.js', 'helpers.js', 'i18n.js', 'model.js', 'scoring.js', 'storage.js', 'cloud.js'];
