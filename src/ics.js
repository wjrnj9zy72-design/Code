 ...
 */
export function icsFor(events, { name = 'Together' } = {}) {
  const lines = [
    'BEGIN:VCALENDAR',
    'VERSION:2.0',
 ...
 */
export function pollEvent(poll, { stamp } = {}) {
...
export function listEvents(list, { stamp } = {}) {
 ...
 */
export function agendaFor({ lists = [], polls = [] } = {}, groupId = '') {
