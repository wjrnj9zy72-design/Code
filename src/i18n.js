...
export const STRINGS = {
  fr: {
    ...
    'schema.ok': 'Base de données à jour.',
    'schema.title': 'Base de données : une mise à jour est à passer',
    'schema.why': 'Pour qui gère la base Supabase. Trois gestes, une seule fois :',
    'schema.copy': 'Copier la mise à jour',
    'schema.copied': 'Copié ✓ ({lines} lignes)',
    'schema.open': 'Ouvrir l’éditeur SQL de Supabase',
    'schema.paste': 'Collez tout dans l’éditeur, puis Run. Réponse attendue : « Success. No rows returned ».',
    'schema.check': 'C’est fait : vérifier',
    'schema.done': 'La base est à jour.',
    'schema.stillBehind': 'La base n’a pas encore la mise à jour : vérifiez que tout a été collé, puis Run.',
    'schema.copyTitle': 'La mise à jour de la base',
    'schema.copyHint': 'Copiez tout ce texte ({lines} lignes), collez-le dans Supabase → SQL Editor → New query, puis Run.',
  ...
  en: {
    ...
    'schema.ok': 'Database up to date.',
    'schema.title': 'Database: an update is waiting',
    'schema.why': 'For whoever runs the Supabase database. Three steps, once:',
    'schema.copy': 'Copy the update',
    'schema.copied': 'Copied ✓ ({lines} lines)',
    'schema.open': 'Open Supabase’s SQL editor',
    'schema.paste': 'Paste it all into the editor, then Run. Expected answer: “Success. No rows returned”.',
    'schema.check': 'Done: check',
    'schema.done': 'The database is up to date.',
    'schema.stillBehind': 'The database does not have the update yet: check that everything was pasted, then Run.',
    'schema.copyTitle': 'The database update',
    'schema.copyHint': 'Copy all of this text ({lines} lines), paste it into Supabase → SQL Editor → New query, then Run.',
