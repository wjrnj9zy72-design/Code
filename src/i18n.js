...
export const STRINGS = {
  fr: {
    ...
    'count.lists': '{count} {count|liste|listes}',
    'count.polls': '{count} {count|sondage|sondages}',
    'count.games': '{count} {count|partie|parties}',
    'count.spends': '{count} {count|compte|comptes}',
    'count.boards': '{count} {count|tableau d’idées|tableaux d’idées}',
    ...
    'polls.settledRange': 'retenu {day}',
    'agenda.add': 'Ajouter à l’agenda',
    'event.title': 'L’événement',
    'event.hintFixed': 'Les personnes de l’événement y seront déjà.',
    'events.new': 'Nouvel événement',
    'events.create': 'Créer l’événement',
    'events.name': 'Le nom',
    'events.day': 'Le jour',
    'events.until': 'Jusqu’au (facultatif, pour plusieurs jours)',
    'events.range': 'du {from} au {to}',
    'events.peopleHint': 'Qui vient (facultatif, on peut en ajouter après).',
    'events.coming': 'À venir',
    'events.none': 'Rien de prévu. Un sondage qui retient une date, ou un événement créé ici, apparaît ici.',
    'events.past': 'Passés ({count})',
    'events.nobody': 'Personne pour l’instant',
    'events.dateHint': 'Le jour part dans les agendas, sous le nom écrit en dessous. L’heure est facultative.',
    'events.share': 'Partager l’événement',
    'events.rename': 'Renommer',
    'event.list': 'Ce qu’on apporte',
    'event.hint': 'Les personnes dispo pour le {day} y seront déjà.',
    'event.addList': '+ Liste de ce qu’on apporte',
    'event.addSpend': '+ Compte des dépenses',
    'event.for': '↩ {name} — {day}',
    'event.forUndated': '↩ {name}',
    'agenda.coming': 'Ce qui vient',
    'agenda.dated': 'Lignes datées',
    'events.title': 'Événements',
    'events.seeAgenda': 'L’agenda',
    'events.noneHome': 'Aucun événement prévu. Créez-en un, ou laissez un sondage retenir une date.',
    'events.more': '… et {count} {count|autre|autres} dans l’agenda.',
    'events.deciding': '{count} {count|sondage cherche|sondages cherchent} encore un jour.',
    'event.forWhich': 'Pour un événement ?',
    'event.none': 'Aucun',
    'event.tag': 'Pour {name} · {day}',
    'event.tagUndated': 'Pour {name}',
    'event.addTo': 'Ajouter à « {name} »',
    'event.addToHint': 'Dans le groupe de l’événement, avec les personnes qui viennent.',
    'event.addMore': '+ Ajouter à l’événement',
    'event.addElsewhere': 'Autre chose, hors de l’événement',
    'agenda.nothing':
    ...
    'spends.what': 'Quoi ?',
    'spends.textPlaceholder': 'Ex. Courses, essence, restau…',
    'spends.amount': 'Combien ?',
    'spends.by': 'Payé par',
    'spends.when': 'Quand',
    'spends.splitTitle': 'Concerne qui ?',
    'spends.splitHint': 'Partagé également entre les personnes cochées.',
    'spends.noOneChosen': 'Choisissez au moins une personne.',
    'spends.add': 'Ajouter la dépense',
    'spends.addFirst': 'Aucune dépense pour l’instant.',
    'spends.noPeople': 'Ajoutez d’abord les personnes que ce compte concerne.',
    'spends.sections': 'Sections du compte',
    'spend.tabExpenses': 'Dépenses',
    'spend.tabBalances': 'Soldes',
    'spends.balancesEmpty': 'Ajoutez d’abord des dépenses.',
    'spends.allSettled': 'Tout est réglé',
    'spends.allSettledHint': 'Personne ne doit rien à personne.',
    ...
    'spends.move': '{from} → {to}',
    'spends.settleHint': 'Le moins de virements possible pour que tout le monde soit à jour. Un virement fait ? « Marquer comme payé » le note, et les soldes suivent.',
    'spends.markPaid': 'Marquer comme payé',
    'spends.repaid': '{from} a remboursé {to}',
    'spends.repayment': 'Remboursement',
    'spends.repayHint': 'Le montant se change si le remboursement n’est que partiel.',
    'spends.repayFrom': 'De',
    'spends.repayTo': 'À',
    ...
    'people.renameHint': 'Son prénom, tel qu’il s’affichera ici.',
    'spends.confirmRemovePerson': 'Retirer cette personne du compte ?',
    'spends.confirmDelete': 'Supprimer ce compte et toutes ses dépenses ? C’est définitif.',
    'spends.loading': 'On va chercher ce compte…',
    'tab.ideas': 'Idées',
    'kinds.ongoing': 'En cours',
    'ideas.new': 'Nouveau tableau d’idées',
    'ideas.none': 'Aucun tableau pour l’instant. Un voyage, un cadeau, un projet : on note et on dessine ce qui vient, avant de décider.',
    'ideas.untitled': 'Tableau sans nom',
    'ideas.name': 'Sujet',
    'ideas.namePlaceholder': 'Voyage en Corse, cadeau de Léa…',
    'ideas.create': 'Créer le tableau',
    'ideas.cards': '{count} {count|carte|cartes}',
    'ideas.notes': '{count} {count|note|notes}',
    'ideas.sketches': '{count} {count|croquis|croquis}',
    'ideas.empty': 'Rien encore. Ajoutez une note ou un croquis : chacun ajoute les siens, rien ne s’écrase.',
    'ideas.addNote': '+ Note',
    'ideas.addSketch': '+ Croquis',
    'ideas.noteTitle': 'Note',
    'ideas.notePlaceholder': 'Une idée, une adresse, un lien…',
    'ideas.sketchTitle': 'Croquis',
    'ideas.caption': 'Légende',
    'ideas.captionPlaceholder': 'Facultatif',
    'ideas.emptySketch': 'Croquis vide',
    'ideas.pen': 'Crayon',
    'ideas.eraser': 'Gomme',
    'ideas.undoStroke': 'Défaire',
    'ideas.rubber.0': 'Gomme fine',
    'ideas.rubber.1': 'Gomme moyenne',
    'ideas.rubber.2': 'Gomme large',
    'ideas.discard': 'Quitter sans enregistrer ? Ce qui a été changé sera perdu.',
    'ideas.discardYes': 'Quitter sans enregistrer',
    'ideas.inks': 'Couleur',
    'ideas.pens': 'Épaisseur',
    'ideas.ink.ink': 'Encre',
    'ideas.ink.red': 'Rouge',
    'ideas.ink.blue': 'Bleu',
    'ideas.ink.green': 'Vert',
    'ideas.ink.orange': 'Orange',
    'ideas.pen.4': 'Fin',
    'ideas.pen.10': 'Moyen',
    'ideas.pen.24': 'Épais',
    'ideas.canvas': 'Zone de dessin : dessinez au doigt ou à la souris',
    'ideas.confirmDeleteCard': 'Supprimer cette carte ?',
    'ideas.full': 'Ce tableau est plein : supprimez des croquis, ou commencez un autre tableau.',
    'ideas.share': 'Partager le tableau',
    'ideas.shared': 'Tableau partagé dans {name}.',
    'ideas.rename': 'Renommer le tableau',
    ...
    'sign.by': 'Proposé par {name}',
    'sign.edit': 'Signature',
    'sign.placeholder': 'Votre surnom',
    'sign.hint':
      'Affiché sous le titre, pour tout le monde — y compris ceux qui ouvrent le lien. Laissez vide pour ne rien afficher.',
    'sign.remember': 'Signer ainsi mes prochains sondages et listes',
  ...
  en: {
    ...
    'count.lists': '{count} {count|list|lists}',
    'count.polls': '{count} {count|poll|polls}',
    'count.games': '{count} {count|game|games}',
    'count.spends': '{count} {count|account|accounts}',
    'count.boards': '{count} {count|idea board|idea boards}',
    'count.none': 'nothing going on',
    ...
    'polls.settledRange': 'settled: {day}',
    'agenda.add': 'Add to calendar',
    'event.title': 'The event',
    'event.hintFixed': 'The people coming will already be in it.',
    'events.new': 'New event',
    'events.create': 'Create the event',
    'events.name': 'Name',
    'events.day': 'Day',
    'events.until': 'Until (optional, for several days)',
    'events.range': '{from} to {to}',
    'events.peopleHint': 'Who is coming (optional, more can be added later).',
    'events.coming': 'Coming up',
    'events.none': 'Nothing planned. A poll that settles on a day, or an event made here, shows up here.',
    'events.past': 'Past ({count})',
    'events.nobody': 'Nobody yet',
    'events.dateHint': 'The day goes into calendars, under the name written below. The hour is optional.',
    'events.share': 'Share the event',
    'events.rename': 'Rename',
    'event.list': 'What to bring',
    'event.hint': 'Whoever is free on {day} will already be in it.',
    'event.addList': '+ What to bring',
    'event.addSpend': '+ Shared expenses',
    'event.for': '↩ {name} — {day}',
    'event.forUndated': '↩ {name}',
    'agenda.coming': 'What’s coming',
    'agenda.dated': 'Lines with a day',
    'events.title': 'Events',
    'events.seeAgenda': 'Agenda',
    'events.noneHome': 'No event planned. Create one, or let a poll settle on a date.',
    'events.more': '… and {count} more in the agenda.',
    'events.deciding': '{count} {count|poll is|polls are} still looking for a day.',
    'event.forWhich': 'For an event?',
    'event.none': 'None',
    'event.tag': 'For {name} · {day}',
    'event.tagUndated': 'For {name}',
    'event.addTo': 'Add to “{name}”',
    'event.addToHint': 'In the event’s group, with the people coming.',
    'event.addMore': '+ Add to the event',
    'event.addElsewhere': 'Something else, not for this event',
    'agenda.nothing':
    ...
    'spends.what': 'What?',
    'spends.textPlaceholder': 'E.g. Groceries, fuel, dinner…',
    'spends.amount': 'How much?',
    'spends.by': 'Paid by',
    'spends.when': 'When',
    'spends.splitTitle': 'Who does it concern?',
    'spends.splitHint': 'Split equally between those ticked.',
    'spends.noOneChosen': 'Choose at least one person.',
    'spends.add': 'Add the expense',
    'spends.addFirst': 'Nothing spent yet.',
    'spends.noPeople': 'Add the people this account is between first.',
    'spends.sections': 'Account sections',
    'spend.tabExpenses': 'Expenses',
    'spend.tabBalances': 'Balances',
    'spends.balancesEmpty': 'Add expenses first.',
    'spends.allSettled': 'All settled',
    'spends.allSettledHint': 'Nobody owes anybody anything.',
    ...
    'spends.move': '{from} → {to}',
    'spends.settleHint': 'The fewest transfers that put everyone straight. Transfer done? “Mark as paid” notes it, and the balances follow.',
    'spends.markPaid': 'Mark as paid',
    'spends.repaid': '{from} paid back {to}',
    'spends.repayment': 'Repayment',
    'spends.repayHint': 'Change the amount if only part of it was paid back.',
    'spends.repayFrom': 'From',
    'spends.repayTo': 'To',
    ...
    'people.renameHint': 'Their first name, as it will show here.',
    'spends.confirmRemovePerson': 'Remove this person from the account?',
    ...
    'tab.ideas': 'Ideas',
    'kinds.ongoing': 'In progress',
    'ideas.new': 'New idea board',
    'ideas.none': 'No board yet. A trip, a present, a project: write down and sketch what comes, before deciding.',
    'ideas.untitled': 'Untitled board',
    'ideas.name': 'Topic',
    'ideas.namePlaceholder': 'Trip to Corsica, Léa’s present…',
    'ideas.create': 'Create the board',
    'ideas.cards': '{count} {count|card|cards}',
    'ideas.notes': '{count} {count|note|notes}',
    'ideas.sketches': '{count} {count|sketch|sketches}',
    'ideas.empty': 'Nothing yet. Add a note or a sketch: everyone adds their own, nothing gets overwritten.',
    'ideas.addNote': '+ Note',
    'ideas.addSketch': '+ Sketch',
    'ideas.noteTitle': 'Note',
    'ideas.notePlaceholder': 'An idea, an address, a link…',
    'ideas.sketchTitle': 'Sketch',
    'ideas.caption': 'Caption',
    'ideas.captionPlaceholder': 'Optional',
    'ideas.emptySketch': 'Empty sketch',
    'ideas.pen': 'Pencil',
    'ideas.eraser': 'Eraser',
    'ideas.undoStroke': 'Undo',
    'ideas.rubber.0': 'Fine eraser',
    'ideas.rubber.1': 'Medium eraser',
    'ideas.rubber.2': 'Broad eraser',
    'ideas.discard': 'Leave without saving? What was changed will be lost.',
    'ideas.discardYes': 'Leave without saving',
    'ideas.inks': 'Colour',
    'ideas.pens': 'Thickness',
    'ideas.ink.ink': 'Ink',
    'ideas.ink.red': 'Red',
    'ideas.ink.blue': 'Blue',
    'ideas.ink.green': 'Green',
    'ideas.ink.orange': 'Orange',
    'ideas.pen.4': 'Thin',
    'ideas.pen.10': 'Medium',
    'ideas.pen.24': 'Thick',
    'ideas.canvas': 'Drawing area: draw with a finger or the mouse',
    'ideas.confirmDeleteCard': 'Delete this card?',
    'ideas.full': 'This board is full: delete some sketches, or start another board.',
    'ideas.share': 'Share the board',
    'ideas.shared': 'Board shared in {name}.',
    'ideas.rename': 'Rename the board',
    ...
    'sign.by': 'Proposed by {name}',
    'sign.edit': 'Signature',
    'sign.placeholder': 'Your nickname',
    'sign.hint':
      'Shown under the title, to everyone — including people who open the link. Leave it empty to show nothing.',
    'sign.remember': 'Sign my next polls and lists this way',
