...
export const STRINGS = {
  fr: {
    ...
    'groups.hint':
      'Un groupe, c’est un cercle de personnes : la famille, les copains du mardi. On y voit tout ce qui est partagé — parties, listes et sondages — et on peut y partager à son tour. On y fait entrer quelqu’un en lui envoyant un lien d’invitation.',
    ...
    'groups.inviteHint':
      'Envoyez ce lien à la personne : elle n’aura que son prénom à écrire. Il vaut {minutes} minutes et une seule entrée. À défaut, dites-lui le nom du groupe et les six chiffres.',
    ...
    'groups.codeHint':
      'Le plus simple est le lien qu’on vous envoie : il n’y a rien à recopier. À défaut, le nom du groupe et les six chiffres font la même chose.',
    ...
    'join.hint': 'Votre prénom, et c’est tout : le reste est dans le lien.',
  ...
  en: {
    ...
    'groups.hint':
      'A group is a circle of people: the family, the Tuesday card players. You see everything shared in it — games, lists and polls — and can share there too. You let someone in by sending them an invitation link.',
    ...
    'groups.inviteHint':
      'Send them this link: all they have to write is their first name. It is good for {minutes} minutes and one device. Failing that, tell them the group\'s name and the six digits.',
    'groups.inviteText': 'A link to join {name}',
    'groups.namePlaceholder': 'group name',
    'groups.codePlaceholder': 'six-digit code',
    'groups.codeHint':
      'The easy way is the link someone sends you: nothing to copy out. Failing that, the group\'s name and the six digits do the same.',
    ...
    'join.hint': 'Your first name, and that is all: the rest is in the link.',
